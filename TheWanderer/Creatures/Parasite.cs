...
namespace Pkuyo.Wanderer.Creatures
{
    ...
    class ParasiteHook : HookBase
    {
        ...
        static public ParasiteHook Instance(ManualLogSource log)
        {
            if (_instance == null)
            {
    ...
    class ParasiteGameSession : GameSession
    {
        ...
        public void SpawnCreatures()
        {
            ...
            AbstractCreature abstractCreature = new AbstractCreature(game.world, StaticWorld.GetCreatureTemplate(WandererModEnum.Creatures.ToxicSpider), null, new WorldCoordinate(0, -1, -1, -1), new EntityID(-1, 0));
